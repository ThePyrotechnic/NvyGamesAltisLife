...
class marketView
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>Altis Market</t>"; //--- ToDo: Localize;
		...
		{
			idc = 1101;
			text = "<t align='center'>Development</t>"; //--- ToDo: Localize;
			x = 17 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 1002;
			text = "Since server started"; //--- ToDo: Localize;
