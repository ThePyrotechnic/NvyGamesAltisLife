...
{
	hint "You are not a member of the ADAC!";
};
...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	//{
		[[0,format["%1, your %2 is being towed by ADAC.",(_vehicleData select 0) select 1,_vehicleName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	//};
	...
	if(player distance _vehicle > 10) exitWith {hint "Towing canceled."; life_action_inUse = false;};
