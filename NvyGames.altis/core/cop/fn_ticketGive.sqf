...
if((parseNumber _val) > 1000000) exitWith {hint "Ticket can not be more expensive than $1000000!"};
[[0,format["%1 has given a $%2 ticket to %3.",name player,[(parseNumber _val)] call life_fnc_numberText,name life_ticket_unit]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
