/*
	...
	*DUE TO BE REWROTE FOR NEW SYSTEM*
	...
	unimpound [BOOL free]
*/
private["_display","_cars","_veh","_sel","_i","_name","_color","_text","_check","_price","_pos","_isfree"];
disableSerialization;


_isfree = BIS_fnc_param[_this,0,false]; //param free
...
if(_veh distance impound_obj < 50) then
{
	...
	[_veh] call life_fnc_vehicleAfterSpawn; //Cleanups, ...
};
