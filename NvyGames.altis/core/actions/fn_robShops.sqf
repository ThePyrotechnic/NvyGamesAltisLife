...
if(_robber distance _shop > 10) exitWith { _shop switchMove ""; hint "You need to stay within 10m to Rob register! - Now the register is locked."; 5 cutText ["","PLAIN"]; _rip = false; deletemarker _marker;};
5 cutText ["","PLAIN"];
