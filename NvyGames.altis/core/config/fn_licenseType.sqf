/*
	...
	returns [shortvar/longvar, Display Name]
...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "cop_sniper": {_var = "license_cop_sniper"}; //##98
			case "tazer": {_var = "license_civ_tazer"};
			
			case "event": {_var = "license_civ_event"};
			case "cop_event": {_var = "license_cop_event"};
			
			case "viewwanted": {_var = "license_civ_viewwanted"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_cop_sniper": {_var = "cop_sniper"}; //##98
			
			case "license_civ_tazer": {_var = "tazer"};
			
			case "license_civ_event": {_var = "event"};
			case "license_cop_event": {_var = "cop_event"};
			
			case "license_civ_viewwanted": {_var = "viewwanted"};
